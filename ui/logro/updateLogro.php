...
if(isset($_POST['update'])){
	$updateLogro = new Logro($idLogro, $nombre, $descripcion, $asignatura, $tipoLogro, $periodo);
	$updateLogro -> update();
	$updateLogro -> select();
	...
	if($_SESSION['entity'] == 'Administrator'){
		$logAdministrator = new LogAdministrator("","Edit Logro", "Nombre: " . $nombre . ";; Descripcion: " . $descripcion . ";; Asignatura: " . $nameAsignatura . ";; Tipo Logro: " . $nameTipoLogro . ";; Periodo: " . $namePeriodo, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		$logAdministrator -> insert();
	}
	else if($_SESSION['entity'] == 'Profesor'){
		$logProfesor = new LogProfesor("","Edit Logro", "Nombre: " . $nombre . ";; Descripcion: " . $descripcion . ";; Asignatura: " . $nameAsignatura . ";; Tipo Logro: " . $nameTipoLogro . ";; Periodo: " . $namePeriodo, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		$logProfesor -> insert();
	}
	else if($_SESSION['entity'] == 'Secretaria'){
		$logSecretaria = new LogSecretaria("","Edit Logro", "Nombre: " . $nombre . ";; Descripcion: " . $descripcion . ";; Asignatura: " . $nameAsignatura . ";; Tipo Logro: " . $nameTipoLogro . ";; Periodo: " . $namePeriodo, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
					...
					<div class="form-group">
						...
						<select class="form-control" name="periodo">
							...
							foreach($periodos as $currentPeriodo){
								...
								if($currentPeriodo -> getIdPeriodo() == $updateLogro -> getPeriodo() -> getIdPeriodo()){
									echo " selected";
								}
