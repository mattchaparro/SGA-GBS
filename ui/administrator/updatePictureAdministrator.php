...
if(isset($_POST['update'])){
	...
	if($type!="image/png"){
		...
		if($_SESSION['entity'] == 'Administrator'){
			...
			$logProfesor = new LogProfesor("","Edit picture in Administrator", "Picture: " . $attribute, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
			$logProfesor -> insert();
		}
		else if($_SESSION['entity'] == 'Secretaria'){
			$logSecretaria = new LogSecretaria("","Edit picture in Administrator", "Picture: " . $attribute, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
