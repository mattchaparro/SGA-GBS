<?php
$processed=false;
$updateSecretaria = new Secretaria($_SESSION['id']);
...
if(isset($_POST['update'])){
	$updateSecretaria = new Secretaria($_SESSION['id'], $nombre, $apellido, $documento, $correo, "", $telefono, $state);
	...
	$logSecretaria = new LogSecretaria("","Edit Profile Secretaria", "Nombre: " . $nombre . ";; Apellido: " . $apellido . ";; Documento: " . $documento . ";; Correo: " . $correo . ";; Telefono: " . $telefono . ";; State: " . $state, date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Edit Profile Secretaria</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/secretaria/updateProfileSecretaria.php") ?>" class="bootstrap-form needs-validation"   >
