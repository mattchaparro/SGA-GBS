...
if(isset($_POST['update'])){
	if($_POST['newPassword'] == $_POST['newPasswordConfirm']){
		...
		if($updateProfesor -> getPassword() == md5($_POST['currentPassword'])){
			$updateProfesor -> updatePassword($_POST['newPassword']);
			...
			$logProfesor = new LogProfesor("","Change Password Profesor", "", date("Y-m-d"), date("H:i:s"), $user_ip, PHP_OS, $browser, $_SESSION['id']);
			$logProfesor -> insert();
			$processed = true;
		} else {
			$error = 2;
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Change Password Profesor</h4>
				</div>
				<div class="card-body">
					<?php if($processed){ ?>
					...
					<?php } ?>
					<form id="form" method="post" action="index.php?pid=<?php echo base64_encode("ui/profesor/updatePasswordProfesor.php") ?>" class="bootstrap-form needs-validation"   >
